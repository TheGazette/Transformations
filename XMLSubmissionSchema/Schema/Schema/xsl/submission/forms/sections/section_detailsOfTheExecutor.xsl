...
http://www.nationalarchives.gov.uk/doc/open-government-licence/-->
  ...
  <xsl:template match="section[@name='executorDetails']" mode="RDFa">
  ...
  <xsl:template match="section[@name='executorDetails']" mode="content">
    ...
    <section id="{@name}">
      ...
      <dl>
        <dt>Surname:</dt>
        <dd about="this:{$personURI}" foaf:familyName="{personName/surname}" id="surName" property="foaf:familyName" typeof="gaz:Person">
          <xsl:value-of select="personName/surname"/>
        </dd>
        <dt>First name:</dt>
        <dd about="this:{$personURI}" foaf:firstName="{personName/forename}" id="foreName" property="foaf:firstName" typeof="gaz:Person">
          <xsl:value-of select="personName/forename"/>
        </dd>
        <dt>Middle name:</dt>
        <dd about="this:{$personURI}" foaf:givenName="{personName/middleNames}" id="middleName" property="foaf:givenName" typeof="gaz:Person">
          <xsl:value-of select="personName/middleNames"/>
        </dd>
