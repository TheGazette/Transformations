...
http://www.nationalarchives.gov.uk/doc/open-government-licence/-->
   <xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:foaf="http://www.gazettes-online.co.uk/ontology/foaf" xmlns="http://www.w3.org/1999/xhtml" version="2.0">
  <!-- legalInformation -->
  ...
  <xsl:template match="section[@name='detailsOfTheAppointee']" mode="content">
    <section xmlns="" id="detailsOfTheAppointee">
      <header>
