...
http://www.nationalarchives.gov.uk/doc/open-government-licence/-->
  ...
  <xsl:template match="section[@name='executorDetails']" mode="content">
    ...
    <section id="{@name}">
      ...
      <dl>
        <dt>Surname:</dt>
        <dd about="this:estateExecutor" property="foaf:familyName" typeof="gaz:Person">
          <xsl:value-of select="familyName"/>
        </dd>
        <dt>First name:</dt>
        <dd about="this:estateExecutor" property="foaf:firstName" typeof="gaz:Person">
          <xsl:value-of select="firstName"/>
        </dd>
        <dt>Middle name:</dt>
        <dd about="this:estateExecutor" property="foaf:givenName" typeof="gaz:Person">
